...
class PetApi
{
     ...
     *
     * @param  \PetstoreClient\Model\Pet $body Pet object that needs to be added to the store (required)
     ...
     * @throws \PetstoreClient\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \PetstoreClient\Model\ApiResponse
     */
     ...
     * @throws \PetstoreClient\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \PetstoreClient\Model\ApiResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function uploadFileWithHttpInfo($pet_id, $additional_metadata = null, $file = null, string $contentType = self::contentTypes['uploadFile'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\PetstoreClient\Model\ApiResponse',
                        $request,
                        $response,
                    );
            }
    ...
    {
        $returnType = '\PetstoreClient\Model\ApiResponse';
        $request = $this->uploadFileRequest($pet_id, $additional_metadata, $file, $contentType);

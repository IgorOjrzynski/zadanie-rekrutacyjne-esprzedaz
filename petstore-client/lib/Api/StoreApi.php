...
class StoreApi
{
     ...
     * @throws \PetstoreClient\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \PetstoreClient\Model\Order, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\PetstoreClient\Model\Order';
        $request = $this->getOrderByIdRequest($order_id, $contentType);
     ...
     *
     * @param  \PetstoreClient\Model\Order $body order placed for purchasing the pet (required)
